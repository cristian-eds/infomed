...
public interface MedicineRepository extends JpaRepository<Medicine, UUID>, JpaSpecificationExecutor<Medicine> {
    ...
    " FROM Medicine m JOIN m.medicineItems mi " +
            ...
            "ORDER BY mi.dayHour")
    Page<CustomMedicineItemDTO> findCustomMedicineItemsWithPagination(@Param("name") String name, @Param("user") User user, org.springframework.data.domain.Pageable pageable);
}
